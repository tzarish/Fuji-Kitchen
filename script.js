const nameText = document.getElementById('nameText');
        ...
        if (svgArchContainer) {
            ...
            letters.forEach((char, index) => {
                ...
                textElement.style.filter = "drop-shadow(0 10px 48px rgba(240, 110, 170, 0.28))";
        ...
        function runCarousel() {
            ...
            if (prev) prev.style.display = (active == 0) ? 'none' : 'block';
            if (next) next.style.display = (active == count - 1) ? 'none' : 'block';
        ...
        window.addEventListener("wheel", function (event) {
            ...
            if (archContainer && letterElements.length > 0) {
